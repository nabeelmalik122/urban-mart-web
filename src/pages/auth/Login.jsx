 ...
 *
 * Login page — glassmorphism card design.
 * Supports Email/Password login and Google sign-in.
 * Apple / Twitter buttons are rendered visually but disabled (non-functional).
 */

import { useState } from 'react'
import { Link, useNavigate } from 'react-router-dom'
import toast from 'react-hot-toast'
import { loginWithEmail, loginWithGoogle, getFriendlyAuthError } from '../../firebase/auth'
...
export default function Login() {
  ...
  async function handleGoogle() {
    ...
    try {
      ...
      toast.success(`Welcome, ${cred.user.displayName ?? 'back'}!`)
      await redirectByRole(cred.user.uid)
    } catch (err) {
      // Ignore popup-closed — user intentionally dismissed it
      ...
      <div className="auth-container">
        ...
        <form className="form" onSubmit={handleSubmit} noValidate>
          ...
          <span className="forgot-password">
            {/* Forgot password — Phase 5 feature, placeholder link for now */}
